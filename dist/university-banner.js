...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__apply_styles__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__apiEndpoints__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_polyfill__ = __webpack_require__(144);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_axios__ = __webpack_require__(346);
...
var universityBanner = function universityBanner() {

    var currentScript = document.getElementById('usnge-markup-call-script');
    var count = currentScript.getAttribute('count');
    var widgetName = currentScript.getAttribute('widget-name');
    var widgetContainer = document.createElement('div');
    widgetContainer.setAttribute('data-widget', widgetName);
    widgetContainer.setAttribute('id', 'widget_wrapper');
    var markUpContent = void 0;
    var createMarkup = function createMarkup() {
        widgetContainer.innerHTML = markUpContent;
        var insertMarkup = function insertMarkup() {
            currentScript.insertAdjacentElement('afterend', widgetContainer);
        };
        insertMarkup();
    };
    ...
    var apiCall = function apiCall() {
        ...
        __WEBPACK_IMPORTED_MODULE_3_axios___default()({
            method: 'POST',
            url: __WEBPACK_IMPORTED_MODULE_1__apiEndpoints__["a" /* default */].api_url,
            headers: {
            ...
            response.data.forEach(function (element, index) {
                ...
                if (index >= count) {
                    ...
                    markUpContent += '<div class="university-row">\n                                <div class="left-side-content">\n                                    <span class="ad-specification">Ad</span>\n                                    <div class="left-text-wrapper">\n                                        <a target="_blank" href="' + response.data[index].page_url + '" class="university-title">' + response.data[index].long_name + '</a>\n                                        <p class="city-detail">Minneapolis, MN & Online</p>\n                                    </div>\n                                </div>\n                                <a target="_blank" href="' + response.data[index].page_url + '"><img class="university-image" src="' + response.data[index].logo + '"></a>\n                                <a target="_blank" href="' + response.data[index].page_url + '" class="more-info-widget-button">More info</a>\n                        </div>';
                } else {
                    markUpContent = '<div class="university-row">\n                                <div class="left-side-content">\n                                    <span class="ad-specification">Ad</span>\n                                    <div class="left-text-wrapper">\n                                        <a target="_blank" href="' + response.data[index].page_url + '" class="university-title">' + response.data[index].long_name + '</a>\n                                        <p class="city-detail">Minneapolis, MN & Online</p>\n                                    </div>\n                                </div>\n                                <a target="_blank" href="' + response.data[index].page_url + '"><img class="university-image" src="' + response.data[index].logo + '"></a>\n                                <a target="_blank" href="' + response.data[index].page_url + '" class="more-info-widget-button">More info</a>\n                        </div>';
                }
                //insert the markup in our 'div' container
            ...
            Object(__WEBPACK_IMPORTED_MODULE_0__apply_styles__["a" /* default */])();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_emotion__ = __webpack_require__(139);
...
var applyStyle = function applyStyle() {
    ...
    // --------------------------------------------------------------
    var widgetWrapper = document.getElementById('widget_wrapper');
    var universityRows = document.getElementsByClassName('university-row');
    var universityTitles = document.getElementsByClassName('university-title');
    var universityImages = document.getElementsByClassName('university-image');
    var moreInfoButton = document.getElementsByClassName('more-info-widget-button');
    var universityList = document.getElementsByClassName('university-list');
    var adText = document.getElementsByClassName('ad-specification');
    var rightSideContent = document.getElementsByClassName('right-side-content');
    var leftSideContent = document.getElementsByClassName('left-side-content');
    var leftTextWrapper = document.getElementsByClassName('left-text-wrapper');
    var cityDetail = document.getElementsByClassName('city-detail');
    // -----------------------------------------------------------------

    //define styles
    // ---------------------------------------------------------
    var bannerStyle = Object(__WEBPACK_IMPORTED_MODULE_0_emotion__["a" /* css */])(_templateObject);

    var rowStyle = Object(__WEBPACK_IMPORTED_MODULE_0_emotion__["a" /* css */])(_templateObject2);

    var leftSideContentStyle = Object(__WEBPACK_IMPORTED_MODULE_0_emotion__["a" /* css */])(_templateObject3);

    var leftTextWrapperStyle = Object(__WEBPACK_IMPORTED_MODULE_0_emotion__["a" /* css */])(_templateObject4);

    var cityDetailStyle = Object(__WEBPACK_IMPORTED_MODULE_0_emotion__["a" /* css */])(_templateObject5);

    var adStyle = Object(__WEBPACK_IMPORTED_MODULE_0_emotion__["a" /* css */])(_templateObject6);

    var titleStyle = Object(__WEBPACK_IMPORTED_MODULE_0_emotion__["a" /* css */])(_templateObject7);

    var rightSideStyle = Object(__WEBPACK_IMPORTED_MODULE_0_emotion__["a" /* css */])(_templateObject8);

    var imageStyle = Object(__WEBPACK_IMPORTED_MODULE_0_emotion__["a" /* css */])(_templateObject9);
    var buttonStyle = Object(__WEBPACK_IMPORTED_MODULE_0_emotion__["a" /* css */])(_templateObject10);
    // ---------------------------------------------------------

    //use the apply() method to transform DOM elements into array elements
    var arrayTransform = function arrayTransform(elementToTransform) {
        return Array.apply(null, elementToTransform);
    };

    //add styles function
    var addStyles = function addStyles(item, style) {
...
/* harmony default export */ __webpack_exports__["a"] = (applyStyle);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_create_emotion__ = __webpack_require__(140);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_emotion_utils__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stylis_rule_sheet__ = __webpack_require__(142);
...
"use strict";
var apiEndPoints = {
  'api_url': 'https://usngewp.staging.wpengine.com/wp-json/wp/v2/usnge-ads-api'
};
